...
class Category_Controller extends Base_Controller {
	...
	/**
	 * Creates the necessary tables required to run the plugin
	 *
	 * @return void
	 */
	public static function install_tables() {
		if ( get_option( 'cky_cookie_category_table_version' ) !== CLI_VERSION ) {
	...
	public static function validate_tables() {
		...
		if ( false === $missing_tables ) {
			...
			update_option( 'cky_cookie_category_table_version', CLI_VERSION );
		}
	}
	/**
	 * Get table schema
